    ...
    $("#calc").click(function(e){
        ...
        if(f.checkValidity()) {
            ...
            case "cashtokg":
                ...
                $("span.weight").text(Math.trunc(weight) + " кг " + Math.trunc((weight - Math.trunc(weight)) * 1000) + " г");
                $("span.height").text(Math.trunc(height) + " м " + Math.trunc((height - Math.trunc(height)) * 1000) + " мм");
